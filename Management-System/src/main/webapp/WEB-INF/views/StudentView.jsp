...
<body>
			...
			<ul class="nav navbar-nav">
				...
				<li role="presentation" class="dropdown"><a
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li><a href="#">Student marks Report</a></li>
						<li><a href="#">Avarage Student Report</a></li>
	...
	<div
		style="overflow: scroll; height: 80px; width: 100%; overflow: auto">
		<h1>Students List</h1>
		<h2>
			<a href="new">New Students</a>
		</h2>

		<table width="800" border="5" class="my-table">
			<th>No</th>
			<th>First Name</th>
			<th>Last Name</th>
			<th>Actions</th>
